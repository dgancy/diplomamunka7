...
function Generate() {
    ...
    if (type === "simple" || type === "lineal") {
        ...
        document.getElementById("hossz").innerHTML = `Szúrja be egy ${hossz} hosszúságú hash táblába a következő objektumokat ${type} ( ${c1} , ${c2} ) hasítás alkalmazásával.`;
        document.getElementById("h").innerHTML = h1 + " .";
    } else if (type === "double") {
        for (let i = 0; i < elemszam; i++) {
            if (i === elemszam) {
    ...
    for (var i = 0; i < hossz; i++){    
        input.innerHTML += '<input type="text" placeholder="'+i+'" name="'
            + i + '" size="4" id="inp' + i + '" className="center">';
    }
...
*/
    return (
        <form>
            <h1 className="highpad">Hashtábla feladatok</h1>
            ...
            <div className="normalpad">
                <div className="highpad" id="generate"></div>
                <div class="row justify-content-center text-center">
